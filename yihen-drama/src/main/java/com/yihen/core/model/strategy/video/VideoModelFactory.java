...
public class VideoModelFactory {
    ...
    private final Map<Long, VideoModelStrategy> strategyMap = new ConcurrentHashMap<>();

    @Autowired
    private List<VideoModelStrategy> strategies;

    @Autowired
    private VolcanoVideoModelStrategy volcanoVideoModelStrategy;
     ...
     * @return 视频模型策略
     */
    public VideoModelStrategy getStrategy(Long modelInstanceId) {
        ...
        // 遍历所有策略，找到支持该模型的策略
        for (VideoModelStrategy strategy : strategies) {
        ...
        return volcanoVideoModelStrategy;
    }
     ...
     * @return 视频模型策略
     */
    public VideoModelStrategy getStrategyByType(String strategyType) {
        for (VideoModelStrategy strategy : strategies) {
